...
\begin{itemize}
  ...
  \item Ablation evidence that encoder choice and fusion method are
        secondary to serialisation format: Bio\_ClinicalBERT and Qwen3-8B
        differ by at most 0.007 C-index within each setting (0.001 in
        Setting~4); concatenation outperforms summation by
        $+$0.028--$+$0.039.
\end{itemize}
