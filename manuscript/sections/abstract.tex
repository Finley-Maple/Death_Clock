...
Encoder choice and fusion method are secondary: among reference (concat)
configurations, encoder family changes C-index by at most 0.007 (less than
0.001 in Setting~4), while concatenation outperforms summation by
$+$0.028--$+$0.039.
