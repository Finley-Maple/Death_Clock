...
\begin{sloppypar}Code and evaluation scripts are available at {\small\url{https://github.com/Finley-Maple/Death\_Clock}}.\end{sloppypar}
...
decoupling.
S3-Full·BCB achieves the highest C-index (0.6371) yet near-chance TD-AUC
