...
survival prediction for all-cause mortality on UK Biobank
($n\,=\,124{,}158$).
...
Together, these findings suggest that \emph{how} temporal structure is
encoded matters more than which specific LLM encodes it --- a hypothesis
corroborated by the fusion ablation and to be confirmed by the pending
encoder-generalisation results (Bio\_ClinicalBERT).
