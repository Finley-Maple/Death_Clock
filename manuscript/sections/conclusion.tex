...
By varying input representation (4 settings), encoder architecture (2
...
decoupled age--event encoding (Setting 4) outperforms prose serialisation
of identical events by $+$0.008 C-index, regardless of encoder or fusion.
