...
def run_survival_study(args: argparse.Namespace) -> None:
    log_message("run_survival_study invoked")
    print("[AutoPrognosis] run_survival_study starting...", flush=True)
    df = load_dataset()
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run AutoPrognosis survival study on the prepared dataset.")
