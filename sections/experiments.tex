...
Code and evaluation scripts are available at \url{https://github.com/Finley-Maple/Death_Clock}.
...
Its TD-AUC profile is unusual: 0.52 at 9.5\,yr (Fig.~\ref{fig:horizon})
...
while concatenation variants (0.622--0.624) exceed it, making fusion
strategy a more consequential choice than encoder selection.
