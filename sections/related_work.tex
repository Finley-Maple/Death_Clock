...
Time2Vec~\cite{time2vec} proposed a model-agnostic continuous time representation combining
a linear trend component and learnable sinusoidal components, providing geometric separation
between events at different timestamps without discretisation.
